...
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'Admin') {
    header("Location: ../login.php"); // Ensure path is correct for redirection
    exit();
}

include '../db_connect.php';

// Capture messages from redirected pages (Add/Edit/Delete)
$message = '';
$status = '';
if (isset($_GET['message'])) {
    // Sanitize and decode the message from the URL
        ...
        <section class="main-content-area">
            ...
            <div class="table-header-controls">
                ...
                <nav class="sub-menu-inline">
                        <a href="admin_add_course.php" class="btn-primary"> 
                            Add New Course
                        </a>
                </nav>
            </div>
                        ...
                        <?php if (count($courses) > 0): ?>
                            <?php foreach ($courses as $course): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                        echo htmlspecialchars($course['first_name'] ? $course['first_name'] . ' ' . $course['last_name'] : 'Unassigned'); 
                                        ?>
                                    </td>
                                    <td>
                                        <div class="tooltip" style="display: inline-block;">
                                            <a href="admin_edit_course.php?id=<?php echo $course['course_id']; ?>">Edit</a>
                                            <span class="tooltiptext">Click to edit course details</span>
                                        </div> 
                                        <span style="padding: 0 5px;">|</span>
                                        <div class="tooltip" style="display: inline-block;">
                                            <a href="admin_delete_course.php?id=<?php echo $course['course_id']; ?>" onclick="return confirm('WARNING: Deleting this course will delete ALL associated attendance and enrollment records. Are you sure?');">Delete</a>
                                            <span class="tooltiptext">Click to delete course</span>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
