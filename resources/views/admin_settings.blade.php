        ...
        <section class="settings-container">
            ...
            <div class="settings-group">
                ...
                <form method="POST" action="{{ url('/admin/settings') }}">
                    @csrf
                    <label for="system_status">Current System Status:</label>
                    <select id="system_status" name="system_status" required>
                        <option value="Online" {{ $current_status === 'Online' ? 'selected' : '' }}>Online (Users can log in)</option>
                        <option value="Maintenance" {{ $current_status === 'Maintenance' ? 'selected' : '' }}>Maintenance (All users blocked)</option>
                        <option value="Limited" {{ $current_status === 'Limited' ? 'selected' : '' }}>Limited (Students blocked, Faculty/Admin active)</option>
                    </select><br>

                    <p>Current Status in DB: <strong>{{ $current_status }}</strong></p>
            ...
            <div class="settings-group">
                ...
                <p>
                    Database connection details are now managed in the <strong>.env</strong> file. 
                    <br>Changes here update the <code>system_settings</code> table used for access control.
                </p>
            </div>
        </section>
    </main>
